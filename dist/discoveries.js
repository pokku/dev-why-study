...
export const formulas = [
  ...
  { nodeId: 'wave-equation', expression: d2('y', 't') + op('=') + sq(mi('v')) + d2('y', 'x'), spoken: '∂²y/∂t² = v² ∂²y/∂x²', hook: 'ギターの弦も、波のルールで動く。', symbols: 'y：弦の変位、x：位置、t：時間、v：波の速さ。∂ は一つの変数に注目した微分。', condition: '一様な弦の小さな振動などを表す、速さが一定の1次元の波動方程式。', trail: ['wave-equation', 'wave', 'music'], basics: ['function', 'calculus'] },
